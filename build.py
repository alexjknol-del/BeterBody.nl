...
# ----------------------------------------------------------------------------
ARTICLES = [
    {'slug': 'terugkerende-lichamelijke-klachten', 'tag': 'Gezondheid', 'title': 'Waarom blijven sommige lichamelijke klachten steeds terugkomen?', 'desc': 'Waarom een stijve nek, zeurende rug of schouder steeds terugkomt, en hoe naar de oorzaak in plaats van alleen de pijn wordt gekeken.', 'date': '2026-09-18', 'intro': 'Een stijve nek na een lange werkdag. Een rug die opspeelt na een weekend klussen. Of een schouder die een paar weken rustig blijft en daarna opnieuw begint te zeuren. Wie met terugkerende klachten bij een osteopaat in Enschede komt, wil meestal niet alleen weten hoe de pijn verminderd kan worden. Het is minstens zo interessant om te onderzoeken waarom dezelfde klacht steeds opnieuw ontstaat.', 'body': [('figure', 'https://images.unsplash.com/photo-1699523229208-be1e1dd9252d?fm=jpg&q=80&w=1600', 'Handen die op een rug drukken tijdens een behandeling', 'Terugkerende klachten vragen om aandacht voor de oorzaak.'), ('p', "Een stijve nek na een lange werkdag. Een rug die opspeelt na een weekend klussen. Of een schouder die een paar weken rustig blijft en daarna opnieuw begint te zeuren. Wie met terugkerende klachten bij een <a href='https://www.osteopathie-enschede.nl/' target='_blank' rel='noopener'>osteopaat in Enschede</a> komt, wil meestal niet alleen weten hoe de pijn verminderd kan worden. Het is minstens zo interessant om te onderzoeken waarom dezelfde klacht steeds opnieuw ontstaat."), ('h2', 'De plek van de pijn vertelt niet altijd het hele verhaal'), ('p', 'Pijn is vaak de reden om hulp te zoeken, maar de plek waar u de pijn voelt, hoeft niet de enige plek te zijn waar iets speelt. Het lichaam beweegt als één geheel. Spieren, gewrichten, bindweefsel en zenuwen beïnvloeden elkaar tijdens dagelijkse bewegingen.'), ('p', 'Een beperkte beweging op de ene plek kan er bijvoorbeeld voor zorgen dat een ander lichaamsdeel meer moet opvangen. Bij een bureauwerker kan langdurig zitten samengaan met een stijve bovenrug en gespannen nekspieren. Wie vervolgens alleen de nek ontziet, maar de dagelijkse houding en bewegingswijze niet verandert, kan merken dat de klachten later opnieuw ontstaan.'), ('h2', 'Gewoontes houden klachten soms in stand'), ('p', 'Het lichaam krijgt iedere dag opnieuw dezelfde prikkels te verwerken. Een verkeerde werkhouding, een eenzijdige manier van bewegen of weinig afwisseling tussen zitten en bewegen kan daardoor steeds opnieuw invloed hebben op dezelfde gebieden.'), ('p', 'Ook buiten het werk zijn er gewoontes die meetellen. Misschien wordt een kind vrijwel altijd aan dezelfde kant gedragen, wordt een zware tas steeds over dezelfde schouder gedragen of wordt een sportbelasting snel opgebouwd. Geen van deze factoren hoeft op zichzelf een probleem te vormen. De combinatie en duur kunnen wel bepalen hoeveel belasting het lichaam dagelijks te verwerken krijgt.'), ('h2', 'Herstel betekent niet altijd dat de oorzaak verdwenen is'), ('p', 'Wanneer een klacht afneemt, is dat natuurlijk prettig. Toch betekent minder pijn niet automatisch dat het lichaam weer volledig belastbaar is. Soms verandert de manier waarop iemand beweegt tijdens een periode met klachten. Een beweging wordt onbewust vermeden of een ander lichaamsdeel neemt extra werk over. Zodra de normale activiteiten worden hervat, kan die compensatie opnieuw merkbaar worden.'), ('p', 'Juist bij klachten die regelmatig terugkeren, kan het daarom interessant zijn om verder te kijken dan het moment waarop de pijn ontstaat. Een Osteopaat in Enschede kan tijdens een onderzoek verschillende delen van het lichaam beoordelen en kijken hoe bewegingen en lichamelijke structuren zich tot elkaar verhouden.'), ('h2', 'Wanneer is verder kijken verstandig?'), ('p', 'Een terugkerende klacht verdient extra aandacht wanneer deze steeds opnieuw ontstaat bij vergelijkbare activiteiten of wanneer het herstel telkens maar tijdelijk is. Ook wanneer een klacht uw werk, sport of dagelijkse bezigheden blijft beïnvloeden, kan een bredere beoordeling meer inzicht geven.'), ('p', 'Een Osteopaat in Enschede kijkt niet alleen naar de plek waar u klachten ervaart, maar onderzoekt het lichaam als geheel. Daarbij wordt gekeken naar bewegelijkheid en onderlinge samenhang. Dat kan helpen om beter te begrijpen welke factoren mogelijk bijdragen aan het terugkerende karakter van een klacht.'), ('p', "U hoeft een terugkerende klacht dus niet automatisch als iets te beschouwen waar u maar mee moet leren leven. Soms vraagt het lichaam om een andere blik op de manier waarop het wordt belast en gebruikt. Een <a href='https://www.osteopathie-enschede.nl/' target='_blank' rel='noopener'>Osteopaat in Enschede</a> kan helpen om die samenhang verder te onderzoeken en vanuit daar te kijken welke aanpak past bij uw situatie.")], 'faq': [], 'related': []},
...
def partners():
  ...
  <div class="wrap">
    ...
    <div class="grid-2">
      ...
      </div><div class="partner"><div class="mark">A</div><div><h3>AED Heroes</h3><p>AEDHeroes biedt compacte AED's, waaronder de Pocket AED, en abonnementen voor onderhoud en vervanging. Bij een hartstilstand kan een AED binnen handbereik het verschil maken.</p><a href="https://aedheroes.nl/" target="_blank" rel="noopener">aed heroes</a></div></div><div class="partner"><div class="mark">T</div><div><h3>Tatanka</h3><p>Tatanka is een Nederlandse smartshop met paddo growkits en smartshopproducten, met uitleg per soort en een overzicht van het aanbod.</p><a href="https://www.tatanka.nl/hawaiian-copelandia-magic-mushroom-grow-kit/" target="_blank" rel="noopener">Hawaiian Copelandia paddo kweekset</a></div></div><div class="partner"><div class="mark">S</div><div><h3>Smartific</h3><p>Smartific is een Nederlandse smartshop met magic truffels, growkits en smartshopproducten, inclusief productinformatie per artikel.</p><a href="https://smartific.nl/shroomshop/magic-truffels/" target="_blank" rel="noopener">Magic Truffels Online</a></div></div><div class="partner"><div class="mark">T</div><div><h3>The Headshop</h3><p>The Headshop is een Nederlandse headshop met kratom en smartshopproducten, met een uitgebreid overzicht per soort en sterkte.</p><a href="https://www.headshop.nl/nl/yellow-borneo-kratom/" target="_blank" rel="noopener">Yellow Borneo Kratom</a></div></div><div class="partner"><div class="mark">P</div><div><h3>Paddo.shop</h3><p>Paddo.shop is een Nederlandse webshop gespecialiseerd in paddo growkits, met uitleg per kweekset en kweekinstructies.</p><a href="https://www.paddo.shop/hawaiian-copelandia-paddo-growkit/" target="_blank" rel="noopener">Hawaiian Copelandia kweekset</a></div></div><div class="partner"><div class="mark">M</div><div><h3>Magictruffels.shop</h3><p>Magictruffels.shop is een Nederlandse webshop voor magic truffels, met een overzicht per soort en de werking ervan.</p><a href="https://www.magictruffels.shop/magic-truffels-kopen-amsterdam/" target="_blank" rel="noopener">mushrocks Amsterdam</a></div></div><div class="partner"><div class="mark">Y</div><div><h3>Yuice.nl</h3><p>Yuice.nl biedt recepten en informatie over gezonde kruidenmixen en specerijencombinaties.</p><a href="https://yuice.nl/" target="_blank" rel="noopener">Yuice.nl</a></div></div><div class="partner"><div class="mark">S</div><div><h3>Frecious</h3><p>Frecious maakt koudgeperste sappen en shots van verse groenten en fruit, zonder toevoegingen, als praktische aanvulling op een gezonde levensstijl.</p><a href="https://www.frecious.bio/" target="_blank" rel="noopener">Slowjuice</a></div></div><div class="partner"><div class="mark">M</div><div><h3>Medical Chairs</h3><p>Medical Chairs levert ergonomische zadelkrukken die een actieve zithouding ondersteunen, wat kan bijdragen aan minder rugklachten tijdens langdurig zitwerk.</p><a href="https://www.medicalchairs.nl/nl/producten/zadelkrukken/" target="_blank" rel="noopener">zadelkrukken</a></div></div><div class="partner"><div class="mark">B</div><div><h3>Brahman Menor</h3><p>Brahman Menor schrijft over spiritualiteit en bewustwording, met artikelen over ontspanning, ademhaling en aandacht voor het eigen gevoel.</p><a href="https://brahmanmenor.com/" target="_blank" rel="noopener">Brahmanmenor.nl</a></div></div><div class="partner"><div class="mark">R</div><div><h3>Rooted in Change</h3><p>Rooted in Change schrijft over koud douchen en ijsbaden, met uitleg over de effecten op stress, weerstand en discipline, en een stappenplan om er rustig mee te beginnen. Daarnaast zijn er workshops te boeken.</p><a href="https://www.rootedinchange.nl/" target="_blank" rel="noopener">Rooted in Change</a></div></div><div class="partner"><div class="mark">M</div><div><h3>Mina's Wereld</h3><p>Mina's Wereld is een Nederlandse receptenblog met Oostenrijkse gerechten en een vaste hoek voor lactosevrij en suikervrij koken, met per recept een toelichting op de vervangers.</p><a href="https://www.minaswereld.nl/lactosevrij-toetje-lekkere-ideeen-en-tips-om-zelf-te-maken/" target="_blank" rel="noopener">lactosevrij toetje</a></div></div><div class="partner"><div class="mark">P</div><div><h3>Pappa Blogt</h3><p>Pappa Blogt wordt geschreven door Steven, vader van twee, en bundelt ruim vijfhonderd artikelen over opvoeding, uitjes met kinderen en praktische gezinstips.</p><a href="https://www.pappablogt.nl/traktatie-school-leuke-en-gezonde-ideeen-voor-elke-gelegenheid/" target="_blank" rel="noopener">traktatie school</a></div></div><div class="partner"><div class="mark">Z</div><div><h3>Zorgbroeder</h3><p>Zorgbroeder levert hulpmiddelen voor buiten de deur: driewielfietsen, duofietsen, scootmobielen en rollators, met advies, halen en brengen, reparatie en onderhoud.</p><a href="https://zorgbroeder.nl/driewielfietsen" target="_blank" rel="noopener">Driewielfiets bij Zorgbroeder</a></div></div>
    </div>
    <div class="callout" style="margin-top:36px">
